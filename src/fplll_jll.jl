...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import fplll_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d41a5a93-b765-542c-87e0-8b980b4b1221"))
platforms = [Pkg.Artifacts.unpack_platform(e, "fplll", artifacts_toml) for e in artifacts["fplll"]]
...
if best_platform === nothing
    @debug("Unable to load fplll; unsupported platform $(triplet(platform_key_abi()))")
else
